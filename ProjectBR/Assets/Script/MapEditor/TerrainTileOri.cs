...
namespace UnityEngine.Tilemaps
{
    ...
    public class TerrainTileOri : TileBase
    {
        [SerializeField]
...
#if UNITY_EDITOR
    [CustomEditor(typeof(TerrainTileOri))]
    public class TerrainTileOriEditor : Editor
    {
        private TerrainTileOri tile { get { return (target as TerrainTileOri); } }
